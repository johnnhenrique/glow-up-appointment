      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <h2 className="heading-lg mb-6">Dra. Rosane Abreu Medeiros</h2>
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              <div className="bg-white p-4 rounded-lg shadow-sm text-center">
                <span className="text-clinic-rose font-bold text-3xl">10+</span>
                <p className="text-gray-600 mt-2">Anos de experiência</p>
              </div>
              <div className="bg-white p-4 rounded-lg shadow-sm text-center">
                <span className="text-clinic-rose font-bold text-3xl">100+</span>
